...
>>>>>>> ba95a6bfb2bdfce6fcd7b60e73247b46d0c6cb36
											...
											<c:forEach items="${list }" var="Info" varStatus="i">
												<tr>
													...
													<td style="text-align: center;">${Info.sales_wd_rati }
														%</td>
													<td style="text-align: center;">${Info.sales_wk_rati}
														%</td>
										...
										<tbody>
											<c:forEach items="${list }" var="Info" varStatus="i">
												<tr>
													...
													<td style="text-align: center;"><span class="fontsize">${Info.sales_0006_rati}%</span></td>
													<td style="text-align: right;"><span class="fontsize">${Info.sales_0611_price }원</span></td>
													<td style="text-align: center;"><span class="fontsize">${Info.sales_0611_rati}%</span></td>
													<td style="text-align: right;"><span class="fontsize">${Info.sales_1114_price }원</span></td>
													<td style="text-align: center;"><span class="fontsize">${Info.sales_1114_rati}%</span></td>
													<td style="text-align: right;"><span class="fontsize">${Info.sales_1417_price }원</span></td>
													<td style="text-align: center;"><span class="fontsize">${Info.sales_1417_rati}%</span></td>
													<td style="text-align: right;"><span class="fontsize">${Info.sales_1721_price }원</span></td>
													<td style="text-align: center;"><span class="fontsize">${Info.sales_1721_rati}%</span></td>
													<td style="text-align: right;"><span class="fontsize">${Info.sales_2124_price }원</span></td>
													<td style="text-align: center;"><span class="fontsize">${Info.sales_2124_rati}%</span></td>
												</tr>
											</c:forEach>
				...
				data : {
					...
					datasets : [
							...
							},
							{
								...
								fill : true,
								borderWidth : 2,
								data : [ 10, 20, 55, 75, 80, 48, 59, 55, 23,
										107, 60, 87 ]
							},
							{
								label : "Ruby",
								...
								fill : true,
								borderWidth : 2,
								data : [ 10, 30, 58, 79, 90, 105, 117, 160,
										185, 210, 185, 194 ]
							} ]
				},
				options : {
