					...
					<div class="d-flex align-items-left flex-column">
						...
						<div class="nav-scroller d-flex">
							<div class="nav nav-line nav-color-info d-flex align-items-center justify-contents-center">
								<a class="nav-link active" href="commercialanalysis">상권분석</a> <a class="nav-link" href="industryanalysis">업종분석</a> <a class="nav-link" href="SaleAnalysis">매출분석</a> <a class="nav-link " href="test4">인구분석</a>
							</div>
						</div>
					</div>
				</div>
