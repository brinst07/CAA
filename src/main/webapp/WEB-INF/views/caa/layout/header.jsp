...
<link rel="stylesheet" href="/resources/assets/css/atlantis.css">
	...
	<div class="wrapper fullheight-side sidebar_minimize">
		...
		<div class="logo-header position-fixed" data-background-color="blue">
			...
			<a href="index.html" class="logo"> <img src="/resources/assets/img/logo.svg" alt="navbar brand" class="navbar-brand">
			</a>
		...
		<nav class="navbar navbar-header navbar-header-transparent navbar-expand-lg">
			...
			<div class="container-fluid">
				...
				<ul class="navbar-nav topbar-nav ml-md-auto align-items-center">
					...
					<!-- 알림 -->
					<li class="nav-item dropdown hidden-caret"><a class="nav-link dropdown-toggle"   id="notifDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
...
<!-- 										</a> <a  > -->
											...
											<div class="notif-content">
												<span class="block"> Farrah liked Admin </span> <span class="time">17 minutes ago</span>
											</div>
										</a>
									</div>
								</div>
							</li>
							<li><a class="see-all" href="javascript:void(0);">See all notifications<i class="fa fa-angle-right"></i>
							</a></li>
						</ul></li>
					...
					<!-- 				</a></li> -->
					<li class="nav-item dropdown hidden-caret"><a class="dropdown-toggle profile-pic" data-toggle="dropdown"   aria-expanded="false">
							<div class="avatar-sm">
						...
						<ul class="dropdown-menu dropdown-user animated fadeIn">
							<div class="dropdown-user-scroll scrollbar-outer">
								<li>
									<div class="user-box">
										<div class="avatar-lg">
											<img src="/resources/assets/img/profile.jpg" alt="image profile" class="avatar-img rounded">
										</div>
										<div class="u-text">
											<h4>Hizrian</h4>
								...
								<li>
									<div class="dropdown-divider"></div> <a class="dropdown-item" >My Profile</a> <a class="dropdown-item" >My Balance</a> <a class="dropdown-item" >Inbox</a>
									<div class="dropdown-divider"></div> <a class="dropdown-item" >Account Setting</a>
									<div class="dropdown-divider"></div> <a class="dropdown-item" >Logout</a>
								</li>
							</div>
						</ul></li>
				</ul>
